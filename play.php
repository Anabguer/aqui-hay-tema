...
<head>
  ...
  <style>
    ...
    /* Retratos: rostro visible sin rediseÃÂ¯ÃÂ¿ÃÂ½ar capas */
    ...
    /* Lo que sabes: iconos pequeÃÂ¯ÃÂ¿ÃÂ½os alineados con la lÃÂ¯ÃÂ¿ÃÂ½nea manuscrita */
...
<body class="play-v3" data-ui="v3" data-debug="0">
  <div class="aht-debug-float" data-debug-float>
    ...
    <div class="aht-debug-panel" data-debug-panel hidden>
      ...
      <button type="button" data-horas="24">+1 dÃÂ¯ÃÂ¿ÃÂ½a</button>
      <button type="button" data-horas="72">+3 dÃÂ¯ÃÂ¿ÃÂ½as</button>
      <button type="button" data-horas="168">+7 dÃÂ¯ÃÂ¿ÃÂ½as</button>
      <button type="button" data-horas="720">+30 dÃÂ¯ÃÂ¿ÃÂ½as</button>
      <button type="button" id="btn-debug-proximo">Ir al prÃÂ¯ÃÂ¿ÃÂ½ximo</button>
      ...
      <div class="aht-sfx-debug" aria-label="Prueba de efectos de sonido">
        ...
        <button type="button" data-aht-sfx="mision">MisiÃÂ¯ÃÂ¿ÃÂ½n</button>
        ...
        <button type="button" data-aht-sfx="nuevo_dia">Nuevo dÃÂ¯ÃÂ¿ÃÂ½a</button>
      </div>
  ...
  <div class="play-lab-overlay" data-play-lab hidden>
    <div class="play-lab-shell" role="dialog" aria-label="Laboratorio DEBUG">
      ...
      <nav class="play-lab-tabs" aria-label="Secciones">
        ...
        <button type="button" data-lab-tab="tecnico">Datos tÃÂ¯ÃÂ¿ÃÂ½cnicos</button>
      </nav>
      <div class="play-lab-body">
        ...
        <section class="play-lab-panel" data-lab-panel="tecnico" hidden>
          <p style="font-size:.78rem;color:#6a5d4f">ExportaciÃÂ¯ÃÂ¿ÃÂ½n tÃÂ¯ÃÂ¿ÃÂ½cnica completa (estado + historial de sesiÃÂ¯ÃÂ¿ÃÂ½n DEBUG).</p>
  ...
  <div class="playtest-cheats" data-playtest-cheats hidden>
    ...
    <button type="button" data-horas="8">+8h</button>
    <button type="button" data-horas="24">+1 dÃÂ¯ÃÂ¿ÃÂ½a</button>
    <button type="button" id="btn-proximo-lab">Ir al prÃÂ¯ÃÂ¿ÃÂ½ximo</button>
  ...
  <aside class="playtest-guia" data-playtest-guia hidden>
    ...
    <h3>Ahora mismo</h3>
    <ul data-pg-ahora></ul>
    <h3>QuÃÂ¯ÃÂ¿ÃÂ½ hacer ahora</h3>
    <ol data-pg-hacer></ol>
    ...
    <details class="playtest-diag" data-playtest-diag open>
      <summary>Registro tÃÂ¯ÃÂ¿ÃÂ½cnico del playtest (copiar para ChatGPT / Carlos I)</summary>
      <div class="diag-actions">
        <button type="button" data-diag-copy>Copiar todo</button>
        <button type="button" data-diag-clear-ui>Limpiar vista</button>
      </div>
      <pre data-playtest-diag-log>(aÃÂ¯ÃÂ¿ÃÂ½n no hay eventos)</pre>
    </details>
    <details class="debug-tec">
      <summary>Datos tÃÂ¯ÃÂ¿ÃÂ½cnicos (resumen avance)</summary>
  ...
  <div class="game-shell">
    <header class="game-top">
      <div class="brand-col">
        <h1 class="brand" aria-label="AquÃÂ­ Hay Tema">
          <span class="brand-text">AQUÃÂ HAY TEMA</span>
          <span class="brand-heart" aria-hidden="true"></span>
        </h1>
        <p class="top-meta-line" data-top-meta-mobile></p>
        <button type="button" class="btn-guia" data-tut-reopen hidden>ÃÂ¿CÃÂ³mo va esto?</button>
      </div>
      <div class="top-center">
        <div class="top-reloj">
          <div class="obj-dia" style="--rot:-2deg">
            <div class="obj-dia-placa">
              <span class="obj-dia-num" data-dia-num>ÃÂ¯ÃÂ¿ÃÂ½</span>
            </div>
            <div class="obj-dia-cuerpo">
              <span class="obj-dia-estacion" data-dia-estacion>Primavera</span>
              <span class="obj-dia-meta" data-dia-meta>ÃÂ¯ÃÂ¿ÃÂ½</span>
            </div>
          ...
          <div class="obj-hora" style="--rot:3deg" aria-label="Hora del pueblo">
            ...
            <span class="obj-hora-val" data-hora>ÃÂ¯ÃÂ¿ÃÂ½</span>
          </div>
      ...
      <button type="button" class="top-vida top-vida-btn" data-open="vida_pueblo" aria-label="Vida del pueblo, pulsa para mÃÂ¯ÃÂ¿ÃÂ½s informaciÃÂ¯ÃÂ¿ÃÂ½n">
      ...
      <div class="control-audio" aria-label="Controles de audio">
        <button type="button" class="control-musica" data-musica-toggle aria-pressed="true" aria-label="Desactivar mÃÂ¯ÃÂ¿ÃÂ½sica" title="Desactivar mÃÂ¯ÃÂ¿ÃÂ½sica">
    ...
    <div class="game-main">
      <aside class="game-left zona-actividad">
        ...
        <section class="shell-grupo proxplanes-movil" data-proxplanes-block aria-label="PrÃÂ³ximos planes programados">
            ...
            <h3 class="pp-mov-tit">PRÃÂXIMOS PLANES<span class="plan-seccion-cnt" data-proxplanes-count hidden aria-hidden="true"></span></h3>
            <span class="plan-seccion-rule" aria-hidden="true"></span>
          </header>
    ...
    <div class="play-root pc" data-pueblo="temprano" data-aforo="1">
      <div class="board-scroll">
        <div class="board-fit">
          ...
          <aside class="selector nota-mapa ds-modal-sheet">
            ...
            <button type="button" class="nota-atras" data-consulta-atras hidden aria-label="AtrÃÂ¯ÃÂ¿ÃÂ½s">? AtrÃÂ¯ÃÂ¿ÃÂ½s</button>
          ...
          <aside class="quien nota-mapa ds-modal-sheet">
            ...
            <section class="quien-bloque quien-bloque--presencia">
              <p class="libreta-kicker quien-kicker">ÃÂ¯ÃÂ¿ÃÂ½QuiÃÂ¯ÃÂ¿ÃÂ½n estÃÂ¯ÃÂ¿ÃÂ½?</p>
      ...
      <div class="mesa">
        <div class="mesa-papel">
          ...
          <div class="dia">
            <div class="dow" data-dow>ÃÂ¯ÃÂ¿ÃÂ½</div>
            <div class="fecha" data-fecha></div>
            <div class="hora" data-hora>ÃÂ¯ÃÂ¿ÃÂ½</div>
          </div>
          <div class="tiempo-juego" aria-label="Avanzar el tiempo">
            ...
            <button type="button" class="tique-dia" data-horas="24" title="Avanzar un dÃÂ¯ÃÂ¿ÃÂ½a">+1 dÃÂ¯ÃÂ¿ÃÂ½a</button>
          </div>
          <div class="hud-right">
            <div class="dinero" data-dinero>ÃÂ¯ÃÂ¿ÃÂ½</div>
      ...
      <aside class="tut-intro" data-tut-intro hidden aria-live="polite">
        <div class="tut-papel" data-tut-papel>
          ...
          <div class="tut-papel-pie">
            ...
            <button type="button" class="cta ghost" data-tut-atras hidden>AtrÃÂ¡s</button>
      ...
      <aside class="vida-derrota" data-vida-derrota hidden aria-live="assertive">
        <div class="tut-papel vida-derrota-papel">
          ...
          <p class="tut-texto">La vida del pueblo ha llegado a un punto crÃÂ¯ÃÂ¿ÃÂ½tico. Celestine no ha podido mantener el equilibrio.</p>
      ...
      <aside class="capa capa-agenda agenda-modal ds-modal-sheet" aria-label="Planes de Celestine">
        ...
        <header class="agenda-cab">
          <div class="ds-modal-head">
            ...
            <p class="ds-modal-sub agenda-sub">Lo que estÃÂ¯ÃÂ¿ÃÂ½ por venir.</p>
          </div>
        </header>
      ...
      <aside class="capa capa-ficha ds-modal-sheet" aria-label="Ficha de vecino">
          ...
          <div class="ficha-hero-info">
            ...
            <div class="ficha-animo-row" data-ficha-animo-row>
              <div class="ficha-animo-pill" data-ficha-animo-pill>
                ...
                <button type="button" class="ficha-animo-q" data-ficha-animo-q hidden aria-label="ÃÂ¯ÃÂ¿ÃÂ½Por quÃÂ¯ÃÂ¿ÃÂ½ estÃÂ¯ÃÂ¿ÃÂ½ asÃÂ¯ÃÂ¿ÃÂ½?">?</button>
              </div>
            </div>
          </div>
        </section>
        <div class="ficha-body">
          ...
          <div class="ficha-col ficha-col-detalles capa-scroll">
            ...
            <section class="ficha-seccion">
              ...
              <button type="button" class="ficha-ver-mas" data-ficha-rel-mas hidden>Ver mÃÂ¯ÃÂ¿ÃÂ½s relaciones</button>
              </div>
            </section>
            <section class="ficha-seccion">
              <h4 class="ficha-seccion-tit">PrÃÂ¯ÃÂ¿ÃÂ½ximos planes</h4>
              <div class="ficha-seccion-body">
        ...
        <div class="ficha-rel-overlay" data-animo-overlay hidden>
          <div class="ficha-rel-modal ficha-modal-animo" role="dialog" aria-label="ÃÂ¯ÃÂ¿ÃÂ½Por quÃÂ¯ÃÂ¿ÃÂ½ estÃÂ¯ÃÂ¿ÃÂ½ asÃÂ¯ÃÂ¿ÃÂ½?">
      ...
      <aside class="capa capa-misiones mis-modal-papel ds-modal-sheet" aria-label="Misiones de hoy">
        ...
        <header class="mis-top">
          ...
          <p class="mis-sub mini" data-misiones-teaser>ÃÂ¯ÃÂ¿ÃÂ½</p>
        </header>
      ...
      <aside class="capa capa-vida-pueblo vida-modal-papel ds-modal-sheet" aria-label="Vida del pueblo" role="dialog" aria-modal="true">
        ...
        <header class="vida-top">
          ...
          <p class="vida-valor" data-vida-modal-valor>ÃÂ¯ÃÂ¿ÃÂ½ / 100</p>
        ...
        <div class="vida-body capa-scroll">
          <div class="vida-copy">
            <p>Esto no es decoraciÃÂ¯ÃÂ¿ÃÂ½n, aunque lo parezca.</p>
            <p>Tus vecinos tienen una peligrosa tendencia a complicarse la vida y, por algÃÂ¯ÃÂ¿ÃÂ½n motivo, ahora son responsabilidad tuya.</p>
            <p>Haz que las cosas salgan bien y el corazÃÂ¯ÃÂ¿ÃÂ½n subirÃÂ¯ÃÂ¿ÃÂ½. DÃÂ¯ÃÂ¿ÃÂ½jalos a su suerte demasiado tiempo yÃÂ¯ÃÂ¿ÃÂ½ bueno, procura que esto no llegue a 0.</p>
          </div>
          <p class="vida-latido mini">ÃÂ¯ÃÂ¿ÃÂ½Llegas a 100? ?? Hay latido.<br>SÃÂ¯ÃÂ¿ÃÂ½, conseguir que este pueblo funcione tiene premio. IncreÃÂ¯ÃÂ¿ÃÂ½ble, pero cierto.</p>
        </div>
      </aside>
      ...
      <aside class="capa capa-diario coti-modal-papel" aria-label="Cotilleos">
        ...
        <header class="coti-top">
          <div class="ds-modal-head">
            ...
            <p class="ds-modal-sub">Lo ÃÂ¯ÃÂ¿ÃÂ½ltimo que corre por el pueblo</p>
          </div>
      ...
      <aside class="capa capa-organizar org-plan-papel ds-modal-sheet" aria-label="Nuevo plan">
        ...
        <div class="org-body capa-scroll">
          <section class="ficha-seccion org-seccion org-seccion--modo">
            <div class="org-seccion-head org-seccion-head--center">
              <div class="org-modo-chips" data-org-modo-row>
                ...
                <button type="button" class="org-modo-chip is-on" data-org-modo="pareja">AcompaÃÂ¯ÃÂ¿ÃÂ½ado</button>
              </div>
            </div>
          </section>
          <section class="ficha-seccion org-seccion org-seccion--quienes">
            <div class="org-seccion-head">
              <h4 class="ficha-seccion-tit">ÃÂ¯ÃÂ¿ÃÂ½QuiÃÂ¯ÃÂ¿ÃÂ½nes van?</h4>
              <p class="org-seccion-meta org-picker-hint" data-org-picker-hint>Elige hasta 2 vecinos.</p>
            </div>
            <div class="ficha-seccion-body">
              <div class="org-busca-wrap">
                <input type="search" class="org-busca" data-org-busca placeholder="Buscar vecinoÃÂ¯ÃÂ¿ÃÂ½" autocomplete="off" aria-label="Buscar vecino"/>
          ...
          <section class="ficha-seccion org-seccion org-seccion--que">
            <h4 class="ficha-seccion-tit">ÃÂ¯ÃÂ¿ÃÂ½QuÃÂ¯ÃÂ¿ÃÂ½ buscamos?</h4>
            <div class="ficha-seccion-body">
              <div class="org-tipos" data-org-tipos></div>
            </div>
          </section>
          <section class="ficha-seccion org-seccion org-seccion--donde">
            <h4 class="ficha-seccion-tit">ÃÂ¯ÃÂ¿ÃÂ½DÃÂ¯ÃÂ¿ÃÂ½nde?</h4>
          ...
          <section class="ficha-seccion org-seccion org-seccion--cuando">
            <h4 class="ficha-seccion-tit">ÃÂ¯ÃÂ¿ÃÂ½CuÃÂ¯ÃÂ¿ÃÂ½ndo?</h4>
            <div class="ficha-seccion-body">
      ...
      <aside class="inicio-proximo-evento" data-proximo-evento-slot hidden aria-label="PrÃÂ³ximo evento">
        ...
        <section class="shell-grupo shell-grupo-cotilleo-par">
          <button type="button" class="obj-cotilleo obj-cotilleo-par" data-open="diario" aria-label="Abrir cotilleo del pueblo">
            ...
            <span class="obj-cotilleo-cuerpo">
              <span class="obj-cotilleo-txt" data-cotilleo-teaser>Hoy estÃÂ¡n sospechosamente tranquilosÃ¢ÂÂ¦</span>
              <span class="obj-cotilleo-badge" data-cotilleo-badge hidden></span>
            </span>
            <span class="obj-cotilleo-flecha" aria-hidden="true">Ã¢ÂÂº</span>
          </button>
        </section>
