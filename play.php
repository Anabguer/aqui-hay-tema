...
<?php /* CANON: V4 visibility + contenido modal â€” ultima autoridad pantallas */ ?>
...
<?php /* CANON: cromatica desktop blindada â€” no mover ni fusionar con inicio-desktop.css */ ?>
<link rel="stylesheet" href="assets/css/design-system/typography-reading.css?v=<?= htmlspecialchars($ahtUi, ENT_QUOTES, 'UTF-8') ?>"/>
  <?php /* CANON: screens.css Ãºltima autoridad shell modal V4 */ ?>
...
<div class="inicio-map-host game-map-wrap">
  ...
  <div class="play-stage">
    <div class="play-root pc" data-pueblo="temprano" data-aforo="1">
      ...
      <aside class="tut-intro" data-tut-intro hidden aria-live="polite">
        <div class="tut-papel" data-tut-papel>
          ...
          <div class="tut-papel-pie">
            ...
            <button type="button" class="cta ghost" data-tut-atras hidden>AtrÃƒÂ¡s</button>
      ...
      <aside class="aht-screen" data-aht-screen="vecinos" aria-label="Vecinos del pueblo">
        <div class="aht-frame">
          <header class="aht-frame-header">
            ...
            <button type="button" class="aht-frame-close" aria-label="Cerrar">âœ•</button>
          </header>
      ...
      <aside class="aht-screen" data-aht-screen="mentes" aria-label="Â¿QuÃ© se cuece ahÃ­?" role="dialog" aria-modal="true">
        <div class="aht-frame">
          <header class="aht-frame-header">
            <h2 class="aht-frame-title">Â¿QuÃ© se cuece ahÃ­?</h2>
            <button type="button" class="aht-frame-close" aria-label="Cerrar">âœ•</button>
          </header>
          <div class="aht-frame-body">
            ...
            <div class="ficha-body">
              <div class="ficha-col ficha-col-detalles capa-scroll">
                ...
                <section class="ficha-seccion ficha-seccion-necesidades" data-ficha-necesidades hidden>
                  <h4 class="ficha-seccion-tit ficha-seccion-tit-sm">QuÃ© le vendrÃ­a bien</h4>
                  <div class="ficha-seccion-body">
      ...
      <aside class="aht-screen" data-aht-screen="ficha_animo" aria-label="Estado de Ã¡nimo del vecino">
        <div class="aht-frame">
          <header class="aht-frame-header">
            <button type="button" class="aht-frame-back" data-animo-volver aria-label="Volver">&#8592;</button>
            <h2 class="aht-frame-title">Ãnimo</h2>
            <button type="button" class="aht-frame-close" aria-label="Cerrar">âœ•</button>
          </header>
          <div class="aht-frame-body">
        ...
        <div class="aht-frame">
          ...
          <div class="aht-frame-body">
            <div style="padding:8px 16px;">
              ...
              <button type="button" class="fdi-orden" data-diario-orden aria-label="Ordenar">&#9783; MÃ¡s reciente</button>
            </div>
        ...
        <div class="aht-frame">
          ...
          <div class="aht-frame-body">
            ...
            <div class="necg-body capa-scroll" data-necesidades-global-body>
              <p class="necg-vacio mini" data-necesidades-global-vacio hidden>Todos estÃ¡n bien por ahora.</p>
            </div>
          </div>
        </div>
      </aside>
      <aside class="aht-screen" data-aht-screen="misiones" aria-label="Misiones de hoy">
        <div class="aht-frame">
          ...
          <div class="aht-frame-body">
            ...
            <p class="mis-sub mini" data-misiones-teaser hidden>â€”</p>
          </div>
        </div>
      </aside>
      ...
      <aside class="aht-screen" data-aht-screen="parejas" aria-label="Parejas del pueblo">
        <div class="aht-frame">
          ...
          <div class="aht-frame-body">
            ...
            <p class="par-sub mini" data-parejas-teaser hidden>â€”</p>
          </div>
        </div>
      </aside>
      ...
      <aside class="aht-screen" data-aht-screen="historia_celebracion" aria-label="Nuevo recuerdo" role="dialog" aria-modal="true">
        <div class="aht-frame">
          <header class="aht-frame-header">
            ...
            <button type="button" class="aht-frame-close" data-historia-celebracion-close aria-label="Cerrar">âœ•</button>
          </header>
          <div class="aht-frame-body">
            <div class="histdet-body histcele-body">
              ...
              <div class="histcele-cta">
                <button type="button" class="histcele-album" data-historia-celebracion-album>IR AL ÃLBUM</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <aside class="aht-screen" data-aht-screen="historia_detalle" aria-label="Detalle del recuerdo" role="dialog" aria-modal="true">
        <div class="aht-frame">
          <header class="aht-frame-header">
            ...
            <button type="button" class="aht-frame-close" data-historia-detalle-close aria-label="Cerrar">âœ•</button>
          </header>
          <div class="aht-frame-body">
      ...
      <aside class="aht-screen" data-aht-screen="vida_pueblo" aria-label="Vida del pueblo" role="dialog" aria-modal="true">
        <div class="aht-frame">
          ...
          <div class="aht-frame-body">
            <p class="vida-valor" data-vida-modal-valor>â€” / 100</p>
            ...
            <div class="vida-copy">
              <p>Esto no es decoraciÃ³n, aunque lo parezca.</p>
              <p>Tus vecinos tienen una peligrosa tendencia a complicarse la vida y, por algÃºn motivo, ahora son responsabilidad tuya.</p>
              <p>Haz que las cosas salgan bien y el corazÃ³n subirÃ¡. DÃ©jalos a su suerte demasiado tiempo yâ€” bueno, procura que esto no llegue a 0.</p>
            </div>
            <p class="vida-latido mini">â€”Â¿Llegas a 100? Â¡Hay latido!<br>SÃ­, conseguir que este pueblo funcione tiene premio. IncreÃ­ble, pero cierto.</p>
          </div>
        </div>
      </aside>
      <aside class="aht-screen" data-aht-screen="buzon" aria-label="Mensajitos">
        <div class="aht-frame">
          ...
          <div class="aht-frame-tabs" role="tablist" aria-label="Filtrar mensajitos">
            ...
            <button type="button" class="aht-frame-tab" data-buzon-tab="leidos" role="tab" aria-selected="false">LEÃDOS</button>
          </div>
        ...
        <div class="aht-frame">
          ...
          <div class="aht-frame-body">
            ...
            <div class="inv-regalo" data-inv-regalo hidden>
              <p class="inv-regalo-titulo">Regalar <strong data-inv-objeto-nombre></strong> aâ€¦</p>
      ...
      <aside class="aht-screen" data-aht-screen="ajustes" aria-label="Ajustes">
        <div class="aht-frame">
          ...
          <div class="aht-frame-body">
            <button type="button" class="ajustes-link" data-ajustes-tut>Â¿CÃ³mo se juega?</button>
            <section class="ajustes-grupo" aria-label="MÃºsica de fondo">
              <div class="ajustes-grupo-head">
                <span class="ajustes-grupo-tit">MÃºsica de fondo</span>
              ...
              <label class="ajustes-vol">
                ...
                <input type="range" class="ajustes-range" min="0" max="100" value="22" data-musica-vol aria-label="Volumen de mÃºsica"/>
              </label>
            </section>
            ...
            <section class="ajustes-grupo ajustes-diag" aria-label="DiagnÃ³stico">
              <div class="ajustes-grupo-head">
                <span class="ajustes-grupo-tit">DiagnÃ³stico</span>
              </div>
              <p class="ajustes-diag-hint">Herramienta tÃ©cnica para copiar o guardar el estado de depuraciÃ³n.</p>
          ...
          <div class="aht-frame-body">
            <div class="org-body capa-scroll">
              ...
              <section class="org-step org-step--quienes">
                <h3 class="org-step-tit">Â¿QuiÃ©nes van?</h3>
                ...
                <div class="org-busca-wrap">
                  ...
                  <input type="search" class="org-busca" data-org-busca placeholder="Buscar vecinoâ€¦" autocomplete="off" aria-label="Buscar vecino"/>
              ...
              <section class="org-step org-step--donde">
                <h3 class="org-step-tit">Â¿DÃ³nde?</h3>
              ...
              <section class="org-step org-step--cuando">
                <h3 class="org-step-tit">Â¿CuÃ¡ndo?</h3>
                <p class="org-step-hint">Selecciona dÃ­a y hora.</p>
      ...
      <button type="button" class="top-vida top-vida-btn" data-open="vida_pueblo" aria-label="Vida del pueblo, pulsa para m&aacute;s informaci&oacute;n">
        ...
        <div class="inicio-evento-card inicio-evento-libreta" data-proximo-evento-card role="status">
          ...
          <button type="button" class="inicio-evento-cta" data-proximo-evento-cta hidden>
            <span class="inicio-evento-cta-txt" data-proximo-evento-cta-txt>Ã‚Â¿Qui&eacute;n va?</span>
...
<?php if (!empty($_GET['modal_catalog'])): ?>
  <!-- ====== MENSAJITOS LAB â€” Piloto DS Modal ====== -->
  <div class="aht-modal-overlay" id="msgLabOverlay" aria-hidden="true">

    <!-- LAB PANEL â€” selector de variantes (solo visible con ?modal_catalog=1) -->
    <div class="aht-modal-lab-panel" id="msgLabPanel" hidden>
      ...
      <label class="aht-modal-lab-tab" data-msg-lab="decision">DecisiÃ³n</label>
      <label class="aht-modal-lab-tab" data-msg-lab="regalo">Regalo</label>
      <label class="aht-modal-lab-tab" data-msg-lab="peticion">PeticiÃ³n</label>
      <label class="aht-modal-lab-tab" data-msg-lab="hilo">Hilo</label>
      <label class="aht-modal-lab-tab" data-msg-lab="leido">LeÃ­do/No</label>
    ...
    <!-- DS MODAL FRAME -->
    <div class="aht-modal" role="dialog" aria-modal="true" aria-label="Mensajitos â€” piloto DS">
      ...
      <!-- ZONA DE NAVEGACIÃ“N: tabs + marcar todos -->
      <nav class="aht-msg-nav" role="tablist" aria-label="Filtros de mensajitos">
        ...
        <button type="button" class="aht-msg-mark-all" id="msgLabMarkAll" hidden>
          <span>Marcar todos como leÃ­dos</span>
        </button>
      </nav>

      <!-- BODY: Contenido dinÃ¡mico segÃºn variante -->
...
<?php endif; ?>
  ...
  <script src="assets/js/play-v3.js?v=v3-20260907-221008'UTF-8') ?>"></script>
