(function () {
  ...
  var defs = [
    ...
    ['proximos-planes','[data-proxplanes-block]'],['mensajitos','.obj-buzon'],
    ['vecinos','.obj-vecinos-resumen'],['nuevo-plan','.obj-nuevo-plan'],
    ['como-va-esto','.btn-guia'],['misiones','[data-inicio-misiones]'],
    ['parejas','[data-inicio-parejas]'],['columna-izquierda','.inicio-mobile-tiles, .inicio-desktop-left'],
