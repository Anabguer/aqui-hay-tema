...
<head>
  ...
  <title><?= $ahtLab ? 'Playtest Â· AquÃ­ Hay Tema' : 'AquÃ­ Hay Tema' ?></title>
  ...
  <style>
    ...
    .playtest-guia .objs li::before { content: "Ã¢ËœÂ"; position: absolute; left: 0; }
    .playtest-guia .objs li.hecho::before { content: "Ã¢Ëœâ€˜"; color: #4a7a3a; }
...
<body class="play-v3" data-ui="v3" data-taller="<?= $ahtTaller ? '1' : '0' ?>" data-lab="<?= $ahtLab ? '1' : '0' ?>">
  ...
  <div class="playtest-float" data-playtest-float>
    <button type="button" class="playtest-float-toggle" data-playtest-toggle aria-expanded="false" title="Controles de playtest">Ã°Å¸Â§Âª Playtest</button>
    <div class="playtest-float-panel" hidden>
      ...
      <button type="button" class="taller-cheat" data-horas="24">+1 dÃ­a</button>
      <button type="button" class="taller-cheat" id="btn-proximo">Ir al prÃ³ximo</button>
  ...
  <?php if (!$ahtLab): ?>
  <div class="taller">
    <strong class="<?= $ahtLab ? 'lab' : '' ?>"><?= $ahtLab ? 'Playtest Neni' : 'AquÃ­ Hay Tema' ?></strong>
    <button type="button" id="btn-nueva">Nueva partida</button>
    <button type="button" class="taller-cheat" id="btn-guardar">Guardar</button>
    <button type="button" class="taller-cheat" data-horas="1">+1h</button>
    <button type="button" class="taller-cheat" data-horas="8">+8h</button>
  ...
  <div class="playtest-cheats" data-playtest-cheats hidden>
    ...
    <button type="button" data-horas="24">+1 dÃ­a</button>
    <button type="button" id="btn-proximo-lab">Ir al prÃ³ximo</button>
  ...
  <aside class="playtest-guia" data-playtest-guia hidden>
    ...
    <details class="playtest-diag" data-playtest-diag open>
      <summary>Registro tÃ©cnico del playtest (copiar para ChatGPT / Carlos I)</summary>
      <div class="diag-actions">
        <button type="button" data-diag-copy>Copiar todo</button>
        <button type="button" data-diag-clear-ui>Limpiar vista</button>
      </div>
      <pre data-playtest-diag-log>(aÃºn no hay eventos)</pre>
    </details>
    <details class="debug-tec">
      <summary>Datos tÃ©cnicos (resumen avance)</summary>
    ...
    <header class="game-top">
      ...
      <div class="top-center">
        ...
        <div class="obj-dinero" style="--rot:0.6deg">
          <span class="obj-dinero-txt" data-dinero>Dinero: Ã¢â‚¬Â¦</span>
        </div>
      </div>
    ...
    <div class="game-main">
      <aside class="game-left zona-actividad">
        ...
        <section class="shell-grupo shell-grupo-buzon">
          <button type="button" class="obj-buzon" data-open="buzon" aria-label="Abrir buzÃ³n">
        ...
        <section class="shell-grupo shell-grupo-planes">
          <div class="obj-proximo">
            <span class="obj-proximo-tit">PrÃ³ximo plan</span>
        ...
        <section class="shell-grupo shell-grupo-cotilleo">
          <button type="button" class="obj-cotilleo" data-open="diario" aria-label="Abrir diario">
            ...
            <p class="obj-cotilleo-txt" data-cotilleo-teaser>Ã¢â‚¬â€</p>
          </button>
        </section>
      </aside>
  ...
  <div class="play-stage">
    <div class="play-root pc" data-pueblo="temprano" data-diario="hoy" data-aforo="1">
      <div class="board-scroll">
        <div class="board-fit">
          <div class="mapa-complejos">
            <button type="button" class="complejo cx-cafe" data-complejo="cafe_libros" aria-label="CafeterÃ­a">
            ...
            <button type="button" class="complejo cx-lola" data-complejo="rincon_lola" aria-label="El RincÃ³n de Lola">
              <span class="edificios">
          ...
          <aside class="selector nota-mapa">
            <button type="button" class="cerrar" data-close aria-label="Cerrar">Ã—</button>
          ...
          <aside class="quien nota-mapa">
            <button type="button" class="cerrar" data-close aria-label="Cerrar">Ã—</button>
            <p class="libreta-kicker">QuiÃ©n estÃ¡</p>
            <h3 data-q-tit></h3>
      ...
      <div class="mesa">
        <div class="mesa-papel">
          ...
          <div class="tiempo-juego" aria-label="Avanzar el tiempo">
            ...
            <button type="button" class="tique-dia" data-horas="24" title="Avanzar un dÃ­a">+1 dÃ­a</button>
          </div>
          <div class="hud-right">
            <div class="dinero" data-dinero>Ã¢â‚¬â€</div>
            <button type="button" class="buzon" data-open="buzon" aria-label="BuzÃ³n">
      ...
      <aside class="capa capa-vecinos">
        <button type="button" class="cerrar capa-cerrar-pestaÃ±a" data-close>cerrar</button>
        <p class="libreta-kicker">Libreta de Celestine</p>
        <h2>Vecinos</h2>
        <p class="mini">Lo que sÃ©, escrito a mano. El resto llegarÃ¡.</p>
        <div data-vecinos-list></div>
      </aside>
      <aside class="capa capa-residencias">
        <button type="button" class="cerrar capa-cerrar-pestaÃ±a" data-close>cerrar</button>
        <p class="libreta-kicker">Libreta de Celestine</p>
        <h2>QuiÃ©n vive aquÃ­</h2>
        ...
        <div class="res-busca-tira">
          <label class="res-busca-etiq" for="res-busca-input">Â¿Buscas a alguien?</label>
      ...
      <aside class="capa capa-organizar">
        ...
        <p class="mini">TÃº propones. Ellas viven.</p>
        <div class="org-row"><label>Â¿Con quiÃ©n?</label><select data-org-a></select></div>
        <div class="org-row"><label>Â¿Y con quiÃ©n mÃ¡s?</label><select data-org-b></select></div>
        <p><strong>Â¿QuÃ© plan?</strong></p>
        <div class="chips" data-org-tipos></div>
        <div class="org-row"><label>Â¿DÃ³nde?</label><select data-org-lugar></select></div>
        <div class="org-row"><label>Â¿QuÃ© dÃ­a?</label><select data-org-dia></select></div>
        <div class="org-row"><label>Â¿A quÃ© hora?</label><select data-org-hora></select></div>
      ...
      <aside class="capa capa-agenda">
        ...
        <p class="libreta-kicker">Libreta de Celestine</p>
        <h2>Planes</h2>
        <p class="mini">Lo que estÃ¡ por venir. Solo consulta.</p>
