...
function addSticker(data){
  ...
  if(!svg){
    var fallback={
      ...
      house:'<svg viewBox="0 0 32 32" fill="none"><path d="M4 16L16 5l12 11" stroke="#e87a5a" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/><path d="M7 14v13h18V14" stroke="#b0c4de" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><rect x="13" y="20" width="6" height="7" rx="1" fill="#f5efe6" stroke="#b0c4de" stroke-width="1.2"/><rect x="10" y="16" width="4" height="3.5" rx=".8" fill="#d4bee8" stroke="#b9a8dc" stroke-width="1"/><rect x="18" y="16" width="4" height="3.5" rx=".8" fill="#d4bee8" stroke="#b9a8dc" stroke-width="1"/></svg>',
