...
<body class="play-v3" data-ui="v3" data-debug="0">
    ...
    <div class="play-root pc" data-pueblo="temprano" data-aforo="1">
      ...
      <aside class="capa capa-vecinos" aria-label="Vecinos del pueblo">
        ...
        <header class="vecinos-cab">
          ...
          <button type="button" class="vecinos-btn-rel" data-vec-rel-btn title="Relaciones del pueblo">
            <svg viewBox="0 0 24 24" aria-hidden="true"><g fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8.5" cy="7.5" r="3"/><path d="M3.2 19c0-3 2.4-4.9 5.3-4.9 2.9 0 5.3 1.9 5.3 4.9"/><circle cx="16.8" cy="9" r="2.3"/><path d="M15.2 13.6c.5-.2 1-.3 1.6-.3 2.4 0 4 1.7 4 4.2"/></g></svg>
        ...
        <div class="vec-rel-overlay" data-vec-rel-overlay hidden>
          <div class="ficha-rel-modal vec-rel-modal" role="dialog" aria-label="Relaciones del pueblo">
            <span class="ficha-tape ficha-tape-l" aria-hidden="true"></span>
            <span class="ficha-tape ficha-tape-r" aria-hidden="true"></span>
            <button type="button" class="cerrar ficha-cerrar" data-vec-rel-close aria-label="Cerrar">×</button>
            <header class="vec-rel-cab">
              <button type="button" class="vec-rel-volver" data-vec-rel-volver>&larr; Vecinos del pueblo</button>
              <h3 class="ficha-rel-modal-tit vec-rel-tit">Relaciones</h3>
            </header>
            <div class="vec-rel-filtros" data-vec-rel-filtros></div>
            <label class="vec-rel-persona-wrap">
              <span class="mini">Ver relaciones de…</span>
              <select class="vec-rel-persona" data-vec-rel-persona></select>
            </label>
            <div class="ficha-rel-scroll capa-scroll vec-rel-scroll" data-vec-rel-list></div>
          </div>
        </div>
      </aside>
      ...
      <aside class="capa capa-ficha" aria-label="Ficha de vecino">
        ...
        <header class="ficha-top">
          ...
          <div class="ficha-nav-row">
            ...
            <button type="button" class="ficha-btn-diario" data-ficha-diario-btn>Diario</button>
        ...
        <div class="ficha-rel-overlay" data-animo-overlay hidden>
          <div class="ficha-rel-modal ficha-modal-animo" role="dialog" aria-label="¿Por qué está así?">
            <span class="ficha-tape ficha-tape-l" aria-hidden="true"></span>
            <span class="ficha-tape ficha-tape-r" aria-hidden="true"></span>
            <button type="button" class="cerrar ficha-cerrar" data-animo-close aria-label="Cerrar">×</button>
            <h3 class="ficha-rel-modal-tit" data-animo-modal-tit>¿Qué le pasa?</h3>
            <div class="ficha-diario-scroll capa-scroll" data-animo-body></div>
          </div>
        </div>
        <div class="ficha-rel-overlay" data-diario-overlay hidden>
          <div class="ficha-rel-modal ficha-modal-diario" role="dialog" aria-label="Diario del vecino">
            <span class="ficha-tape ficha-tape-l" aria-hidden="true"></span>
            <span class="ficha-tape ficha-tape-r" aria-hidden="true"></span>
            <button type="button" class="cerrar ficha-cerrar" data-diario-close aria-label="Cerrar">×</button>
            <h3 class="ficha-rel-modal-tit" data-diario-modal-tit>Su diario</h3>
            <div class="ficha-diario-scroll capa-scroll" data-diario-list></div>
          </div>
        </div>
      </aside>
      ...
      <aside class="game-right zona-personas">
        ...
        <section class="shell-grupo proxplanes-movil" data-proxplanes-block aria-label="Próximos planes programados">
          <header class="pp-mov-cab">
            <svg class="pp-mov-ico" viewBox="0 0 24 24" aria-hidden="true"><rect x="3.2" y="5" width="17.6" height="15.4" rx="2.4" fill="none" stroke="currentColor" stroke-width="1.7"/><path d="M3.4 9.6h17.2" stroke="currentColor" stroke-width="1.7"/><path d="M8.2 3.2v3.4M15.8 3.2v3.4" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg>
  ...
  <aside class="vida-derrota" data-vida-derrota hidden role="alertdialog" aria-live="assertive" aria-labelledby="vida-derrota-tit" aria-describedby="vida-derrota-txt">
    <div class="vida-derrota-papel">
      <span class="vida-derrota-cinta vida-derrota-cinta--l" aria-hidden="true"></span>
      <span class="vida-derrota-cinta vida-derrota-cinta--r" aria-hidden="true"></span>
      <svg class="vida-derrota-corazon" viewBox="0 0 58 52" aria-hidden="true">
        <defs>
          <clipPath id="vd-corazon-clip"><path d="M29 48.5 C29 48.5 5.5 31 4.5 17.5 C3.5 8.5 11.5 2.5 19.5 3.5 C24.5 4 28 8.5 29 9.5 C30 8 33.5 3.5 38.5 3 C46.5 2 53.5 9 52.5 18.5 C51 32 29 48.5 29 48.5 Z"/></clipPath>
          <linearGradient id="vd-agua-grad" x1="29" y1="52" x2="29" y2="0" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stop-color="#b04a60"/>
            <stop offset="100%" stop-color="#c96f82"/>
          </linearGradient>
        </defs>
        <path fill="#e9dcc4" d="M29 48.5 C29 48.5 5.5 31 4.5 17.5 C3.5 8.5 11.5 2.5 19.5 3.5 C24.5 4 28 8.5 29 9.5 C30 8 33.5 3.5 38.5 3 C46.5 2 53.5 9 52.5 18.5 C51 32 29 48.5 29 48.5 Z"/>
        <g clip-path="url(#vd-corazon-clip)">
          <rect class="vida-derrota-agua" x="0" y="40" width="58" height="14" fill="url(#vd-agua-grad)"/>
        </g>
        <path class="vida-derrota-corazon-linea" fill="none" stroke-width="1.6" stroke-linecap="round" d="M29 48.5 C29 48.5 5.5 31 4.5 17.5 C3.5 8.5 11.5 2.5 19.5 3.5 C24.5 4 28 8.5 29 9.5 C30 8 33.5 3.5 38.5 3 C46.5 2 53.5 9 52.5 18.5 C51 32 29 48.5 29 48.5 Z"/>
      </svg>
      <p class="libreta-kicker vida-derrota-kicker">El corazón del pueblo</p>
      <h2 id="vida-derrota-tit" class="vida-derrota-tit">Se nos va de las manos</h2>
      <p id="vida-derrota-txt" class="vida-derrota-txt">La vida del pueblo ha llegado a un punto crítico. Celestine no ha podido mantener el equilibrio.</p>
      <p class="vida-derrota-nota">Los vecinos se han apagado poco a poco, sin que nadie pudiera evitarlo.<br/>Siempre se puede empezar de nuevo.</p>
      <details class="vida-derrota-debug" data-vida-debug hidden>
        <summary>DEBUG · Equilibrio / Final</summary>
        <pre data-vida-debug-body>[AHT DEBUG EQUILIBRIO / FINAL]</pre>
      </details>
      <div class="vida-derrota-acciones">
        <button type="button" class="cta vida-derrota-btn vida-derrota-btn--ok" data-vida-derrota-ok>Entendido</button>
        <button type="button" class="cta ghost vida-derrota-btn" data-vida-derrota-reiniciar>Empezar de cero</button>
      </div>
    </div>
  </aside>
