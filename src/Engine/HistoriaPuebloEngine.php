...
final class HistoriaPuebloEngine
{
    ...
    public const CATÁLOGO_VISUAL = [
        ...
        ['id' => 'hito_06',           'nombre' => 'PUES NO HA IDO NADA MAL…',  'imagen' => 'assets/img/historia/06.png', 'plantilla' => 'La cita de {p1} y {p2} ha ido de maravilla. Esto promete.', 'recompensa' => null],
        ['id' => 'hito_07',           'nombre' => 'TIERRA, TRÁGAME',           'imagen' => 'assets/img/historia/07.png', 'plantilla' => 'La cita de {p1} y {p2} ha sido un desastre. No se puede decir más suave.', 'recompensa' => null],
        ...
        ['id' => 'hito_13',           'nombre' => 'SE HA LIAO',                'imagen' => 'assets/img/historia/13.png', 'plantilla' => '{p1} y {p2} han tenido una discusión fuerte. Las cosas se han puesto tensas.', 'recompensa' => null],
        ...
        ['id' => 'hito_33',           'nombre' => 'AQUÍ HUELE A COTILLEO',     'imagen' => 'assets/img/historia/33.png', 'plantilla' => '{p1} ha estado al quite de lo que no le importa. Uy… aquí huele a cotilleo.', 'recompensa' => null],
        ['id' => 'el_primer_cumple', 'nombre' => 'EL PRIMER CUMPLEAÑOS',       'imagen' => 'assets/img/historia/34.png', 'plantilla' => 'El primer cumpleaños del pueblo. {p1} celebró con {p2}, {p3} y más gente. Esto había que apuntarlo.', 'recompensa' => null],
    ];
